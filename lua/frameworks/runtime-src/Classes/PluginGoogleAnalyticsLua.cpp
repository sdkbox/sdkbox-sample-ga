...
int lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setMetric(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 2)
    {
        int arg0;
        std::string arg1;
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "sdkbox.PluginGoogleAnalytics:setMetric");
        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "sdkbox.PluginGoogleAnalytics:setMetric");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setMetric'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginGoogleAnalytics:setMetric",argc, 2);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setMetric'.",&tolua_err);
#endif
    return 0;
}
...
int lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setUser(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    {
        std::string arg0;
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sdkbox.PluginGoogleAnalytics:setUser");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setUser'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginGoogleAnalytics:setUser",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setUser'.",&tolua_err);
#endif
    return 0;
}
...
int lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setDimension(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 2)
    {
        int arg0;
        std::string arg1;
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "sdkbox.PluginGoogleAnalytics:setDimension");
        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "sdkbox.PluginGoogleAnalytics:setDimension");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setDimension'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginGoogleAnalytics:setDimension",argc, 2);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setDimension'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_PluginGoogleAnalyticsLua_PluginGoogleAnalytics(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PluginGoogleAnalytics");
        ...
        tolua_function(tolua_S,"setUser", lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setUser);
        tolua_function(tolua_S,"stopSession", lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_stopSession);
        tolua_function(tolua_S,"setDimension", lua_PluginGoogleAnalyticsLua_PluginGoogleAnalytics_setDimension);
